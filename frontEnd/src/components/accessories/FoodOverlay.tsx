...
const FoodEntryOverlay: React.FC<prop> = (props) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await axios.post(
        " https://calorierose.vercel.app/api/meal",
        {
          food,
          meal: props.mealType,
          type: foodType,
      ...
      <div className="lg:w-[30vw] lg:h-[50vh] bg-white p-4 rounded shadow-lg">
        ...
        <div className="mb-4">
          ...
          >
            ...
            {foodOptions[foodType as keyof typeof foodOptions]?.map(
              (item, index) => (
        ...
        <div className="mb-4 flex items-center">
          <label
            ...
            className="block text-sm font-medium text-gray-700 mb-1 flex-col"
          >
            Quantity
            <input
              value={quantity}
        ...
        <div className="flex justify-between">
          ...
          <button
            onClick={props.close}
            className="ml-4 w-20 bg-red-500 text-white py-2 rounded-lg hover:bg-red-600 focus:outline-none"
          >
            Close
          </button>
        </div>
